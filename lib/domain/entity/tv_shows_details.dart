...
import 'package:themoviedb/domain/entity/tv_shows_details_videos.dart';
...
class TvShowsDetails {
  ...
  final TvShowsDetailsVideos videos;
  ...
  Map<String, dynamic> toJson() => _$TvShowsDetailsToJson(this);
}
