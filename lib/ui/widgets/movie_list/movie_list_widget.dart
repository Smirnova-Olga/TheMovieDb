...
class MovieListWidgetState extends State<MovieListWidget> {
  final movies = [
    Movie(
      id: 1,
      imageName: const AssetImage(AppImages.sonik),
    ...
    Movie(
      id: 2,
      imageName: const AssetImage(AppImages.superpitomcy),
      title: 'Суперпитомцы',
      time: '29 июля 2022',
      description:
    ...
    Movie(
      id: 3,
      imageName: const AssetImage(AppImages.korolevaUga),
      title: 'Королева Юга',
      time: '18 окт 2022',
      description:
    ...
    Movie(
      id: 4,
      imageName: const AssetImage(AppImages.hulk),
    ...
    Movie(
      id: 5,
      imageName: const AssetImage(AppImages.lou),
      title: 'Лу',
      time: '23 сент 2022',
      description:
    ...
    Movie(
      id: 6,
      imageName: const AssetImage(AppImages.doctorStrendzh),
    ...
    Movie(
      id: 7,
      imageName: const AssetImage(AppImages.pinokkio),
      title: 'Пиноккио',
      time: '30 мар 2022',
      description:
          'Поселившись в Грин Хилз, Соник стремится доказать, что у него есть все задатки настоящего героя. И геройское испытание не заставляет себя долго ждать: злодейский доктор Роботник вновь строит козни. На этот раз — с загадочным напарником Наклзом. Вместе они разыскивают бесценный изумруд, в котором заключены силы, способные уничтожать целые цивилизации. Соник объединяется с лисенком Тейлзом, чтобы отправиться в кругосветное путешествие и найти изумруд до того, как он попадет в плохие руки.',
    ...
    Movie(
      id: 9,
      imageName: const AssetImage(AppImages.spyfamily),
      title: 'Семья шпиона',
      time: '2022',
      description:
    ...
    Movie(
      id: 10,
      imageName: const AssetImage(AppImages.chaki),
      title: 'Чаки',
      time: '2021',
      description:
    ...
    Movie(
      id: 11,
      imageName: const AssetImage(AppImages.tor),
    ...
    Movie(
      id: 12,
      imageName: const AssetImage(AppImages.focuspocus2),
      title: 'Фокус-покус 2',
      time: '30 сент 2022',
      description:
    ...
    Movie(
      id: 13,
      imageName: const AssetImage(AppImages.scoobydoo),
